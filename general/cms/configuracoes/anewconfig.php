		...
		<container>
			<div id="container">
				<div class="webcenter flex-column">
					<div id="content"></div>
					<div id="footer">
						<b><?php echo $hotel['cms_name']; ?></b> CMS <?php echo $hotel['cms_version']; ?> | <?php echo $hotel['hotelname']; ?> © Todos os direitos reservados
						<div class="float-right">
							Com amor por: <b><?php echo $hotel['cms_developers']; ?></b>
						</div>
					</div>
				</div>
			</div>
