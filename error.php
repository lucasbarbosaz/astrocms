...
<html lang="pt-Br">
	<head>
		...
		<link rel="stylesheet" href="http://localhost/general/assets/css/error.css?<?php echo time(); ?>" type="text/css" media="all"/>
		<link rel="stylesheet" href="http://localhost/general/assets/css/types.css?<?php echo time(); ?>" type="text/css"/>
